...
class ili9341(ili9XXX):
    ...
    def __init__(self,
        miso=12, mosi=13, clk=14, cs=15, dc=2, rst=-1, power=-1, backlight=21, backlight_on=1, power_on=0,
        spihost=esp.HSPI_HOST, spimode=0, mhz=80, factor=4, hybrid=True, width=320, height=240, start_x=0, start_y=0,
